...
class TransformTests(unittest.TestCase):
    ...
    def test_GIVEN_a_blank_transform_WHEN_applied_to_a_set_of_points_THEN_transform_has_no_effect(
        self,
    ):
        test_position = [5, 6, 7]
    ...
    def test_GIVEN_transformation_WHEN_applying_transformation_and_then_inverse_THEN_original_position_recovered(
        self,
    ):
        test_position = [5, 6, 7]
        ...
        self.assertTrue(
            np.array_equal(test_position, inverse_transform.evaluate(transformed_position))
        )
