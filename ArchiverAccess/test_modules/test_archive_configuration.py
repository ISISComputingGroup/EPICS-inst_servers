...
class TestConfiguration(TestCase):
    ...
    def test_GIVEN_config_has_header_with_template_WHEN_get_header_THEN_header_with_template_returned_with_pv(
        self,
    ):
        pvname = "pv_name.VAL"
    ...
    def test_GIVEN_config_has_header_with_template_no_formatter_WHEN_get_header_THEN_header_with_template_returned_with_pv(
        self,
    ):
        pvname = "pv_name.VAL"
        header_line = "{pv_name}"
    ...
    def test_GIVEN_config_has_blank_default_field_WHEN_get_header_THEN_pv_is_as_in_header(self):
        ...
        expected_header_line = "{0}"
        config = (
            ArchiveAccessConfigBuilder("filename.txt", default_field="").header(header_line).build()
        )
    ...
    def test_GIVEN_config_has_set_default_field_WHEN_get_header_THEN_pv_is_as_in_header_with_field(
        self,
    ):
        pvname = "pv_name"
        default_field = "FIELD"
        ...
        expected_header_line = "{0}"
        config = (
            ArchiveAccessConfigBuilder("filename.txt", default_field=default_field)
            .header(header_line)
            .build()
        )
    ...
    def test_GIVEN_config_has_set_default_field_and_pv_has_field_WHEN_get_header_THEN_pv_is_as_in_header_without_default_field(
        self,
    ):
    ...
    def test_GIVEN_config_has_header_with_converter_template_WHEN_get_header_THEN_header_with_template_returned_with_pv(
        self,
    ):
    ...
    def test_GIVEN_config_has_header_with_converter_template_no_formatter_WHEN_get_header_THEN_header_with_template_returned_with_pv(
        self,
    ):
        expected_pvname = "pv_name.VAL"
    ...
    def test_GIVEN_config_has_header_with_multiple_repeating_pvs_WHEN_get_header_THEN_header_with_template_returned_with_pv(
        self,
    ):
        ...
        pv_indexes = {
            "index_pv1": pv_indexs.index(pvname1),
            "index_pv2": pv_indexs.index(pvname2),
            "index_pv3": pv_indexs.index(pvname3),
        }

        assert_that(
            results,
            contains_exactly(
                expected_header_line1.format(**pv_indexes),
                expected_header_line2.format(**pv_indexes),
            ),
        )

    def test_GIVEN_config_has_no_continuous_logging_filename_WHEN_get_filenames_THEN_nothing_returned(
        self,
    ):
    ...
    def test_GIVEN_config_has_a_continuous_logging_filename_WHEN_get_filenames_THEN_filename_returned(
        self,
    ):
        expected_filename = "filename.txt"
        config = ArchiveAccessConfigBuilder(
            continuous_logging_filename_template=expected_filename
        ).build()
    ...
    def test_GIVEN_config_has_an_on_end_logging_filename_WHEN_get_filenames_THEN_filename_returned(
        self,
    ):
