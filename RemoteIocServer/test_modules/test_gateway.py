...
class GatewayTests(unittest.TestCase):
    ...
    def test_GIVEN_gateway_has_no_iocs_configured_WHEN_call_generate_gateway_file_THEN_get_empty_gateway_file(
        self, *_
    ):
        gateway = GateWay(
            local_pv_prefix=TEST_LOCAL_PV_PREFIX,
    ...
    @patch("RemoteIocServer.gateway.GateWay._reapply_gateway_settings")
    @patch("RemoteIocServer.gateway.print_and_log")
    def test_GIVEN_gateway_has_iocs_configured_WHEN_call_generate_gateway_file_THEN_get_appropriate_lines(
        self, *_
    ):
        gateway = GateWay(
            local_pv_prefix=TEST_LOCAL_PV_PREFIX,
